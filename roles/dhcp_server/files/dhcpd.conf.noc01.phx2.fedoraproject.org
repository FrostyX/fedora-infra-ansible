...
subnet 10.5.129.0 netmask 255.255.255.0 {
    ...
    host bvh-aarch64-19-br0 {
        ...
        next-server 10.5.126.41;
        option host-name "openqa-aarch64-01-eth1.arm.fedoraproject.org";
        filename "/uefi/grubaa64.efi";
    }
    host openqa-aarch64-02-eth1 {
        hardware ethernet 50:6B:4B:6A:D3:C0;
        fixed-address 10.5.129.244;
        next-server 10.5.126.41;
        option host-name "openqa-aarch64-02-eth1.arm.fedoraproject.org";
        filename "/uefi/grubaa64.efi";
    }
    host openqa-aarch64-03-eth1 {
        hardware ethernet 50:6B:4B:6B:0A:40;
        fixed-address 10.5.129.245;
        next-server 10.5.126.41;
        option host-name "openqa-aarch64-03-eth1.arm.fedoraproject.org";
        filename "/uefi/grubaa64.efi";
    }
    host openqa-aarch64-04-eth1 {
        hardware ethernet 50:6B:4B:6A:C4:B0;
        fixed-address 10.5.129.246;
        next-server 10.5.126.41;
        option host-name "openqa-aarch64-04-eth1.arm.fedoraproject.org";
        filename "/uefi/grubaa64.efi";
    }
